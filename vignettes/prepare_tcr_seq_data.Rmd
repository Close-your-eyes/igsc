...
This V(D)J-sequence can then be used to concatenate the complete TCR (attach the constant gene segment) or a whole expression cassette with additional elements like
